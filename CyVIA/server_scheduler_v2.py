...
db_user, db_pass, db_host, db_port, db_name = 'admin', 'Samsung_1234', '192.168.0.90', '5984', 'cyvia_nodes'
...
def load_db_master():
    ...
    for doc in db:
        ...
        try: # loading process list only, for all nodes
            ...
            # print(json.dumps(master_doc[doc['HostName']]['CVEs'], indent=2))
...
def check_for_changes():
    ...
    for doc2 in db:
        ...
        try:
            ...
            # print('\nLength:', len(vulns), len(master_doc[doc2['HostName']]['CVEs']))
            new_vulns = Diff(master_doc[doc2['HostName']]['CVEs'], vulns)
